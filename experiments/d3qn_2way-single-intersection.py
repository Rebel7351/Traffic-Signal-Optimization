...
if __name__ == "__main__":
    ...
    out_csv_ddqn = f"outputs/2way-single-intersection/d3qn/homo_{experiment_time}_alpha{args.alpha}_gamma{args.gamma}_eps{args.epsilon}_decay{args.decay}_reward{args.reward}"
